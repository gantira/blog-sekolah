<x-app-layout>
    ...
    <article class="entry">
        ...
        <div class="entry-img">
            <img src="{{ asset('eterna/img/blog-1.jpg') }}" alt="" class="img-fluid">
        </div>
    ...
    <article class="entry">
        ...
        <div class="entry-img">
            <img src="{{ asset('eterna/img/blog-2.jpg') }}" alt="" class="img-fluid">
        </div>
    ...
    <article class="entry">
        ...
        <div class="entry-img">
            <img src="{{ asset('eterna/img/blog-3.jpg') }}" alt="" class="img-fluid">
        </div>
    ...
    <article class="entry">
        ...
        <div class="entry-img">
            <img src="{{ asset('eterna/img/blog-4.jpg') }}" alt="" class="img-fluid">
        </div>
