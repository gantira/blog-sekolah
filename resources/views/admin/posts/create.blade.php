        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <p>A mobile and touch friendly input spinner component for Bootstrap 3. It supports
                            the mousewheel and the up/down keys.</p>
                        <div class="form-group">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" id="clockPicker3">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-primary" id="check-minutes">Check the
                                        Minutes</button>
                                </div>
                            </div>
                        </div>
                        <p>For documentations Clockpicker you can visit <a
                                href="http://weareoutman.github.io/clockpicker/" target="_blank">here.</a>
                        </p>
                    </div>
                </div>
            </div>
