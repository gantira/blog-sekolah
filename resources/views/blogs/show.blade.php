                ...
                <div class="row">
                    ...
                    <div class="entries">
                        ...
                        <div class="blog-author clearfix">
                            <img src="{{ asset('eterna/img/user.jfif') }}" class="rounded-circle float-left" alt="">
                        ...
                        {{-- <div class="blog-comments">
                            ...
                            <div id="comment-1" class="comment clearfix">
                                <img src="eterna/img/comments-1.jpg" class="comment-img  float-left" alt="">
                            ...
                            <div id="comment-2" class="comment clearfix">
                                <img src="eterna/img/comments-2.jpg" class="comment-img  float-left" alt="">
                                ...
                                <div id="comment-reply-1" class="comment comment-reply clearfix">
                                    <img src="eterna/img/comments-3.jpg" class="comment-img  float-left" alt="">
                                    ...
                                    <div id="comment-reply-2" class="comment comment-reply clearfix">
                                        <img src="eterna/img/comments-4.jpg" class="comment-img  float-left" alt="">
                            ...
                            <div id="comment-3" class="comment clearfix">
                                <img src="eterna/img/comments-5.jpg" class="comment-img  float-left" alt="">
                            ...
                            <div id="comment-4" class="comment clearfix">
                                <img src="eterna/img/comments-6.jpg" class="comment-img  float-left" alt="">
